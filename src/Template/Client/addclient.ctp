...
$(document).ready(function(){
	$('body').on('click','.yes',function(){
		...
		var data = $(".modal img").attr("src");
		alert(data);
		jQuery("html").append("<div id='image_popup'><img src='"+imgsrc+"'></div>")
	});
...
#gender-div label
{
	padding-right:15px;
		  ...
		  <div class="form-group">
				...
				<div class="form-group">
							...
							echo $this->Form->radio('gender',$gender_options,array('default'=>'Male','class'=>'gender-radio'));
							?>
							</div>
	...
	<div class="header panel-body">
			...
			<div class="form-group">
						...
						<div class="col-sm-4">
							<?php echo $this->Form->input('',array('name'=>'mobile_no','class'=>'form-control validate[required]','placeholder'=>__('Mobile Number'),'required'=>'required','pattern'=>'([0-9]{10,15})'));?>
						</div>
						</div>
