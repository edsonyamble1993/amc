...
<li class=""><i class="fa fa-tachometer image_icon" aria-hidden="true"></i>
   ...
   <?php } ?>
	...
	<?php if($this->Amc->findstatus($user_role,'client')==1){   ?>				
   	<li class='has-sub1'><i class="fa fa-users image_icon" aria-hidden="true"></i><?php echo $this->Html->link(__('Client'),['controller' => 'Client', 'action' => 'clientlist']);?></a>
...
<?php if($this->Amc->findstatus($user_role,'employee')==1){   ?>
   ...
   <?php if($this->Amc->findstatus($user_role,'quotation')==1){   ?>
     	<li class='has-sub1'><i class="fa fa-credit-card-alt image_icon" aria-hidden="true"></i><?php echo $this->Html->link(__('Quotation'),['controller' => 'quotation', 'action' => 'quotationlist']);?></a>
     
   </li>
     <?php } ?>
    <?php if($this->Amc->findstatus($user_role,'sales')==1){   ?>
   	<li class='has-sub1'><i class="fa fa-tty image_icon" aria-hidden="true"></i><?php echo $this->Html->link(__('Purchase'),['controller' => 'Sales', 'action' => 'viewsales']);?></a>
   ...
   <li class='has-sub1'><i class="fa fa-bookmark image_icon" aria-hidden="true"></i><?php echo $this->Html->link(__('AMC'),['controller' => 'amc', 'action' => 'viewamc']);?></a>
   ...
   <li class='has-sub1'><i class="fa fa-indent image_icon" aria-hidden="true"></i><?php echo $this->Html->link(__('Complaint'),['controller' => 'complaint', 'action' => 'viewcomplaint']);?></a>
