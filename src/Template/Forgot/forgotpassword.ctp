...
<div class="mainlogin login_amc">		
	<div class="panel-body main-class">
		...
		<table align="center" class="table" style="width:33em">
			...
			<tr>
			<td>
				<span id='reset_label'>Forgot Password</span>
			</td>
			</tr>
			
			<tr>
				<td>
				<input type='email' name='email' class='form-control input_text validate[required]' placeholder='Enter Valid E-mail'>
				</td>
			</tr>
			...
			<tr>
				<td>
					<a href="<?php echo $this->request->base; ?>/Users/login" class="forgot_link pull-right">Login</a>
				</td>
			</tr>
	</table>
