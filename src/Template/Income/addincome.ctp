...
<div class="row">
				<ul role="tablist" class="nav nav-tabs panel_tabs" style="padding-left:30px;">
					  ...
					  <li class="">
					<?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list fa-lg')) .__('Monthly Income'),array('controller'=>'Income','action' => 'monthincome'),array('escape' => false));
						?>
        </li>
				</ul>
</div>
...
<div class="form-group">
				...
				<div class="form-group">
						 ...
						 ?>
                                <select name="status" class="form-control" required="required">
                                    ...
                                    <?php
                                        foreach($options_status as $status_key=>$status_value){
                                        	?>
				...
				<div class="form-group">
							<div class="col-sm-2">
							<?php echo $this->Form->label(__('Date : '));?><span class="require-field">*</span>
							</div>
							<div class="col-sm-10">
				...
				<div id="custom_label">
						...
						<div class="col-sm-3">
							<input id="income_amount" class="form-control text-input" type="text" value="" name="custom_label[]" placeholder="Income Amount">
						</div>
						<div class="col-sm-5">
							<input id="income_entry" class="form-control text-input" type="text" value="" name="custom_value[]" placeholder="Income Entry Label">
						</div>
						<div class="col-sm-2">
			...
			<div class="col-sm-3">
				...
				<div class="form-group">
							...
							<?php echo $this->Form->input('Create Income Entry',array('type'=>'submit','name'=>'add','class'=>'btn btn-success'));?>
							</div>
				</div>
			<?php $this->Form->end(); ?>
