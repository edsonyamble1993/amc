...
<form method="post" accept-charset="utf-8" id="client_form" class="form_horizontal formsize" enctype="multipart/form-data" action="<?php echo $this->Url->build(array('controller'=>'Income','action'=>'monthincome'))?>">
					<div class="header">
...
<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
		<thead>
				<tr>
					...
					<th class="text-center">Income Label</th>
			...
			<?php $i = 1; $grandtotal = 0; foreach($request_list as $request_lists){ ?>
					...
					<td class="text-center"><?php echo $this->AMC->gettotalincome($request_lists['income_id']);?></td>
					<?php $grandtotal +=  $this->AMC->gettotalincome($request_lists['income_id']); ?>
					</tr>
		...
		<table class="table" style="border:1px solid #ddd" width="100%">
			<tbody><tr>
				...
				<td colspan="2" class="text-center" align="center"><?php echo $grandtotal; ?></td>
