<div class="pg-header">
	<h4 class="install_title"><span style="height:30px"><img  src="../webroot/img/Thumbnail-img2.png" height="80%" /></span> <?php echo __("Tam - AMC Installation Wizard");?></h4>
</div>
...
<div class="panel panel-success ">
      <div class="panel-heading">	  
		...
		<a href='<?php echo $this->request->base; ?>/'><b><i><u><?php echo __("Click") ?></u></i></b></a> <?php echo __("here to redirect on 	login page.");?>
	  </div>
