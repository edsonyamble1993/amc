...
<head>
	...
	<?= $this->Html->css('imgareaselect-default.css') ?>
	<?= $this->Html->css('jquery.awesome-cropper.css') ?>
	...
	<?= $this->Html->css('style-example.css') ?>
	<?= $this->Html->css('jquery.Jcrop.css') ?>
	<?= $this->Html->css('stylecrop.css') ?>
...
<!-- Latest compiled and minified JavaScript -->
    ...
    <?= $this->Html->script('jquery.awesome-cropper.js')?>
     <?= $this->Html->script('jquery.Jcrop.js')?>
     <?= $this->Html->script('jquery.SimpleCropper.js')?>
     <?= $this->Html->script('jquery.imgareaselect.js')?>
